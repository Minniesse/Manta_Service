                ...
                <div className={style.body}>
                    <div className={style.body_left}>
                        <div className={style.BL_avg_data}>
                            <div className={style.avg_velocity}>
                                <svg className={style.avg_icon} id={style.velocity_icon}xmlns="http://www.w3.org/2000/svg"  fill="none">
                                    <circle cx="15" cy="15" r="15" fill="#A4C663"/>
                                </svg>
                            ...
                            <div className={style.avg_roadtime}>
                                <svg className={style.avg_icon} xmlns="http://www.w3.org/2000/svg"  fill="none">
                                    <circle cx="15" cy="15" r="15" fill="#BF5F65" fill-opacity="0.2"/>
                                </svg>
                    ...
                    <div className={style.body_mid}>
                        ...
                        <div className={style.BM_data}></div>
                    </div>
                    <div className={style.body_right}></div>
                </div>
            </div>
